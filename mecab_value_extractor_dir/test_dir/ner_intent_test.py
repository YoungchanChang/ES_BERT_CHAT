import os
from mecab_value_extractor_dir.ner_intent_dir import ner_string
from mecab_value_extractor_dir.ner_intent_dir import data_utility
...
def test_ner_string():
    ...
    for idx, csv_item in enumerate(data_utility.read_csv(csv_dir)):
        is_same = False
    ...
    print(is_same_cnt, "/", len(data_utility.read_csv(csv_dir)))
    data_utility.write_csv(write_dir, tmp_list)
