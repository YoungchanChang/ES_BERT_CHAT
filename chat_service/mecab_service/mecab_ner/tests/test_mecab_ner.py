...
def test_read_category():
    storage_path = "/chat_service/mecab_service/mecab_ner/datas/entities/storage"
...
def test_read_intent_category():
    storage_path = "/chat_service/mecab_service/mecab_ner/datas/intents/storage"
...
def test_mecab_ner():
    ...
    entity_storage_path = "/chat_service/mecab_service/mecab_ner/datas/entities/mecab_storage"
    ...
    intent_storage_path = "/chat_service/mecab_service/mecab_ner/datas/intents/mecab_storage"
...
def test_word_sense_disambiguation():
    ...
    entity_storage_path = "/chat_service/mecab_service/mecab_ner/datas/intents/mecab_storage"
    mecab_ner = MeCabNer(storage_mecab_path=entity_storage_path)
